...
from core.model_basic import define_problem_7
...
def solve_model(instance, verbose=True):
    ...
    parametrization, evaluate, constraints = define_problem_7(instance) #Haim
    ...
    }, 444, constraints, loss_hist, totvio_hist
